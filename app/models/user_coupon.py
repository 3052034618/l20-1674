...
class UserCoupon(Base):
    ...
    external_user_id: Mapped[str] = mapped_column(String(128), default="", index=True, comment="外部用户标识")
    partner_id: Mapped[str] = mapped_column(String(64), default="", index=True, comment="合作方/活动方标识")
    biz_serial_no: Mapped[str] = mapped_column(String(128), default="", index=True, comment="业务流水号")
